...
<Modal show={EditModal} onHide={handleCreateModalClose}>
      ...
      <Row>
          ...
          <br/><br/>
              <p className='par'> مدارس </p>
          <br/>

        <button className='transs btn-block lini' onClick={AddGrade}>اضافة مرحلة لمدرسة</button> &nbsp;	
        <button className='transs btn-block lini' onClick={AddSchool}>اضافة مدرسة </button> 
        <button className='transs'><Link className='btn-block lin' to="/stages" >مراحل المدرسة</Link> </button><br/> <br/> 
  ...
  <tbody>
    <tr>
      ...
      <td>اكاديمية جيمس الاسكندريه		</td>
      <td></td>
      <td> <button className='trans'><Link to="/details" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-journal-text" viewBox="0 0 16 16">
