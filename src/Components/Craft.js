...
<Modal show={AddSchoolModal} onHide={handleCreateModalClose}>
      ...
      <Modal show={AddGradeModal} onHide={handleCreateModalClose}>
        ...
        <Modal.Body>
          <p className="labe">النشاط </p>
          <input type="text"/>
          
          <p className="labe">انواع الانشطه</p>
...
<Modal show={EditModal} onHide={handleCreateModalClose}>
      ...
      <Row>
          ...
          <br/><br/>
              <p className='par'> Craft </p>
          <br/>

          <button className='transs btn-block lini' onClick={AddGrade}>اضافة نوع نشاط للانشطة</button> &nbsp;	
        <button className='transs btn-block lini' onClick={AddSchool}>اضافة نشاط </button> 
        <button className='transs'><Link className='btn-block lin' to="/Cstages" >انواع الانشطة</Link> </button><br/> <br/> 
  ...
  <tbody>
    <tr>
      ...
      <td></td>
      <td></td>
      <td> <button className='trans'><Link to="/Cdetails" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-journal-text" viewBox="0 0 16 16">
