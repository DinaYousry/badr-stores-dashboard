...
const StagesUniversity = () => {
  ...
  return (
    <>
      ...
      <Row>
          ...
          <Button className='btn-block' onClick={CreateLevel}>اضافة مستوى دراسي</Button> 
          <Button className='btn-block' onClick={CreateStage}> اضافة مرحلة</Button> <br/> <br/> 
  ...
  <tbody>
    <tr>
      <td>Engineering Preparatory Department	</td>
      <td>اعدادى هندسه		</td>
...
export default StagesUniversity